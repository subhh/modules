 ...
 */
namespace OpacScraper\ILS\Driver;
 ...
 * @link     https://vufind.org/wiki/development:plugins:ils_drivers Wiki
 */
class OpacScraper extends \VuFind\ILS\Driver\AbstractBase
    implements HttpServiceAwareInterface
{
    ...
    /**
     * Timeout to use in requests in HTTP header
     *
     * @var int
     */
    ...
    /**
     * ContentType to use in requests in HTTP header
     *
     * @var string
     */
     ...
     * @var string
     */
    protected $contentTypesRequest = 'application/json';
    ...
    {
        $this->baseUrl = $this->config['global']['base-url'];
    }
...
*/
        $http_headers = [
            'Content-type: ' . $this->contentTypesRequest,
            'Accept: ' . $this->contentTypesRequest,
        ];
        ...
        try {
            $result = $this->httpService->get(
                $this->baseUrl,
                $params, $this->timeout, $http_headers
            );
        } catch (\Exception $e) {
